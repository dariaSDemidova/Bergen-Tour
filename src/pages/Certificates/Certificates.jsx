    ...
    return (
        ...
        <div className="container">
            ...
            <div className="box box1">
                ...
                <div className="box-text">Почувствуйте себя волшебниками, <span class="box-text-orange">подарите
            ...
            <div className="box box2"> <img className="number" src={number2} alt="number2"/>
                <div className="box-text">
                    Вы можете приобрести в нашей компании Подарочный Сертификат <span class="box-text-orange">на круиз,
            ...
            <div className="box box3">
                <img src={number3} class="number" alt="number3"/>
